...
# dir="sbatch_log/small_dataset_liver_seg"
# dir="sbatch_log/dataset_liver_seg_mse_2"
dir="sbatch_log/rendered_dataset_liver_seg_gallbladder_removed_class_no_less_than_3"
adversary_param=$"25"
num_vae_steps=$"2"
...
do
    ...
    do 
        EXPT=rendered_dataset_liver_seg_gallbladder_removed_class_no_less_than_3_EXPT_MULTI_VAAL_adver"$adversary_param"_mse"$mse_gamma"_Seed"$seed"
