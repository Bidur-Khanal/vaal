...
class multi_modal_VAAL_Solver2:
    ...
    def sample_for_labeling(self, vae_image, discriminator_image, vae_depth, discriminator_depth, unlabeled_dataloader, unlabeled_indices):
       
        querry_indices = self.sampler.sample(vae_image, 
                                             discriminator_image, vae_depth, discriminator_depth,
